...
/bin/sed -i "s@<FPM_HOST>@${CODE_PORT_9000_TCP_ADDR}@"     /etc/nginx/sites-enabled/default
/bin/sed -i "s@<FPM_PORT>@${CODE_PORT_9000_TCP_PORT}@"     /etc/nginx/sites-enabled/default
